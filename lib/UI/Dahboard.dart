import 'package:cheque_print/UI/printhere.dart';
...
class TableDataSource extends DataGridSource {
  ...
  TableDataSource(this._context, {required x1}) {
    ...
    dataGridRows = x1.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
          DataGridCell<String>(
  ...
  DataGridRowAdapter? buildRow(DataGridRow row) {
    return DataGridRowAdapter(
      ...
      return Container(
          ...
          child:
          dataGridCell.columnName == "AccountPay" ?
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(
              ...
              ElevatedButton(onPressed: (){
                Navigator.of(_context).push(
                    MaterialPageRoute(builder:(context)=>PrintHere(a1:a1,a2:a2,a3:a3,a4:a4,a5:a5,a6:a6,)));
              }, child: Text("Print"))
