...
class _DashboardState extends State<Dashboard> {
  ...
  Future<void> createExcel() async {
    ...
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("A1"), "SR-NO");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("B1"), "CHEQUEDATE");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("C1"), "CHEQUE NO");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("D1"), "AMOUNT");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("E1"), "PAYEENAME");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("F1"), "AccountPay");

    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("A2"), "1");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("B2"), "19-01-2023");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("C2"), "23456 8765223 8923 32");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("D2"), "123456789");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("E2"), "Feeltech Solutions");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("F2"), "Yes");

    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("A3"), "2");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("B3"), "20-02-2023");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("C3"), "23456 5465223 6533 45");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("D3"), "123456789");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("E3"), "Feeltech Solutions");
    excel.updateCell(excel.getDefaultSheet().toString(),CellIndex.indexByString("F3"), "No");
    ...
    final String fileName =
    Platform.isWindows ? '$directory\\Output.xlsx' : '$directory/Output.xlsx';
  ...
  if(bulkprintData == bulkprintData!){
                    ...
                    child: pw.Stack(children: [
                      ...
                      pw.Positioned(
                          ...
                          child: pw.SizedBox(
                              height: 50,
                              width: 50,
                              child: bulkprintData[i].elementAt(5).toString() == "Yes" ||
                      ...
                      pw.Positioned(
                          top: 105,
                          left: 443,
                          child: pw.Text("*** ${NumberFormat.simpleCurrency(locale: 'hi-In',decimalDigits: 2).format(int.parse(bulkprintData[i].elementAt(3).toString()))}/-".replaceAll("₹","" ),
                              style: pw.TextStyle(
                                // letterSpacing: 1,
                                fontSize: 10,
                                color: PdfColors.black,
    ...
    final snackBar = SnackBar(
      duration: Duration(seconds: 2),
      content: const Text("Data is not in Format!"),
      backgroundColor: Color(0xFF076799),
      action: SnackBarAction(
        label: 'dismiss',
        onPressed: () {},
